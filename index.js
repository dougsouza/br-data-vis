...
function update_details(state, postal, year)
{
    ...
    d3.json(file_name, function(data) {
        ...
        for(var i=0; i<data.length; i++)
        {
            ...
            {
                console.log(data[i]);
                main({title: "Scholarships distribution"}, data[i]);
                break;
            }
        }
    });
...
defaults.width = document.getElementById("details-container").offsetWidth;
defaults.height = document.getElementById("details-container").offsetHeight/1.5;
...
function main(o, data) {
  ...
  if (opts.title) {
    $("#chart").prepend("<p class='treemap-title'>" + opts.title + "</p>");
  }
...
/*if (window.location.hash === "") {
    d3.json("br-data/test2.json", function(data) {
        main({title: "Scholarships distribution"}, data);
    });
}
*/
